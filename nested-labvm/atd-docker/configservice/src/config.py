...
INTERNAL_EVENT_CHECK_INTERVAL = int(os.getenv('INTERNAL_EVENT_CHECK_INTERVAL', 60))  # seconds
UILANDING_UPTIME_URL = os.getenv('UILANDING_UPTIME_URL', 'http://atd-uilanding:80/uptimeWithRuntime')
INTERNAL_EVENT_THRESHOLDS_JSON = os.getenv('INTERNAL_EVENT_THRESHOLDS', '')  # JSON override
