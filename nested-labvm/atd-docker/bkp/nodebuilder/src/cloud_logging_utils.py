#!/usr/bin/env python3
"""
Cloud Logging Utility for Login Container Scripts
Provides centralized cloud logging setup for all login container scripts
"""
...
def setup_cloud_logging(service_name, default_labels=None):
    ...
    base_labels = {
        ...
        'environment': 'nodebuilder-container'
    }
